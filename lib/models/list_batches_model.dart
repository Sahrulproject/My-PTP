...
//
//     final listBatchesModel = listBatchesModelFromJson(jsonString);

import 'dart:convert';

ListBatchesModel listBatchesModelFromJson(String str) =>
    ListBatchesModel.fromJson(json.decode(str));

String listBatchesModelToJson(ListBatchesModel data) =>
    json.encode(data.toJson());

class ListBatchesModel {
  String? message;
  List<Batches>? data;

  ListBatchesModel({this.message, this.data});

  factory ListBatchesModel.fromJson(Map<String, dynamic> json) =>
      ListBatchesModel(
